...
const Profile = () => {
    ...
    return (
        <>
            <Helmet>
                <title>GDSC BLOG | Profile</title>
                <meta name="description" content="This is the profile page of Google Developers Students Club" />
                <meta name="keywords" content="profile, react, blog, gdsc, google, tezpur" />
            </Helmet>
