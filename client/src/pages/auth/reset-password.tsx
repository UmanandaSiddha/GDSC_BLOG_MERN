...
const ResetPassword = () => {
    ...
    return (
        <>
            <Helmet>
                <title>GDSC BLOG | Reset Password</title>
                <meta name="description" content="This is the password reset page of Google Developers Students Club" />
                <meta name="keywords" content="password, reset, react, blog, gdsc, google, tezpur" />
            </Helmet>
