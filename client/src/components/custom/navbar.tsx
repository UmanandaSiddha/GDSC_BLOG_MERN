                        ...
                        <Link to="/profile" className='flex justify-center items-center gap-2'>
                            ...
                            <div className='h-12 w-12'>
                                {userContext.user.avatar ? (
                                    <img className="object-cover text-center rounded-full" src={userContext.user.avatar} alt="" />
                                ) : (
                                    <div className='flex h-full w-full justify-center items-center bg-gray-300 rounded-full'>
                                        <p className='text-center text-lg font-semibold'>{userContext.user.name.split(" ")[0][0]}{userContext.user.name.split(" ")[1][0]}</p>
                                    </div>
                                )}
                            </div>
                        </Link>
